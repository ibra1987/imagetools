...
function Showcase() {
  ...
  return (
    <div className="w-full z-10 md:p-10 bg-transparent flex flex-col text-slate-400 justify-start items-center rounded bg-gray-700 mt-4  ">
      <ul className="w-full grid grid-cols-1 place-items-center gap-4 md:divide-x   divide-gray-600   md:grid-cols-3 p-4 ">
        <li className="w-full h-48  flex flex-col justify-center  items-center  font-medium ">
          ...
          <p className="w-full md:h-60 py-4  indent-3   font-normal text-sm">
        ...
        <li className="w-full  md:h-48 flex flex-col justify-center   my-10  items-center space-x-4  font-medium ">
          ...
          <p className="w-full  md:h-48 my-6 indent-3  font-normal text-sm ">
        ...
        <li className="w-full h-48 flex flex-col justify-center      items-center space-x-4 font-medium ">
          ...
          <p className="w-full h-48 my-6 indent-3  font-normal text-sm">
