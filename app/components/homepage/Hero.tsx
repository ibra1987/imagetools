function Hero() {
  return (
    <div className=" w-full bg-yellow-400 p-20 flex flex-col justify-center items-center px-10 relative">
      ...
      <p className="text-gray-500 p-4 w-11/12 md:w-3/5 text-sm">
